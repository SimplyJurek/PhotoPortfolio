    ...
    <main>
        ...
        <section class="my-story-container">
            ...
            <div class="my-story-button-container">
                <a href="mailto:jerzy.baldy@student.up.krakow.pl" class="my-story-button-link">Let's work together!</a>
            </div>
        </section>

        <section class="counter-section">
            <div class="couter-container">
                <p class="counter-text">So far, I have uploaded<span class="counter">1368</span>photos.</p>
                <a href="" class="counter-link">Click here to see them all!</a>
            </div>
        </section>
